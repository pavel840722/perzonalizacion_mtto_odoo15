odoo.define('button_near_create.kanban_button', function(require) {
   ...
   var KanbanButton = KanbanController.include({
       ...
       var self = this;
        this.do_action({
           ...
           res_model: 'df.maintenance.search.work.order',
           name :_('Rastreo de Petición'),
           view_mode: 'form',
           view_type: 'form',
           views: [[false, 'form']],
           target: 'new',
   ...
   var MaintenanceRequestKanbanView = KanbanView.extend({
       config: _.extend({}, KanbanView.prototype.config, {
           Controller: KanbanButton
       }),
   });
   viewRegistry.add('button_in_kanban', MaintenanceRequestKanbanView);
});